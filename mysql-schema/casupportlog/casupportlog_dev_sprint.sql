...
CREATE TABLE `dev_sprint` (
  ...
  `committed_story_point` int NOT NULL DEFAULT '0',
  `deliverd_story_point` int NOT NULL DEFAULT '0',
  `scope_creep` int NOT NULL DEFAULT '0',
  `scope_creep_description` text,
  `spill_over_sp` int NOT NULL DEFAULT '0',
