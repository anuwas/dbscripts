...
CREATE TABLE `subscription_package` (
  ...
  `subscription_package_name` varchar(145) DEFAULT NULL,
  `subscription_package_description` varchar(145) DEFAULT NULL,
  `validto` date DEFAULT NULL,
  `num_of_days` int(10) NOT NULL DEFAULT '0',
...
INSERT INTO `subscription_package` VALUES (1,'Pack 1','Pack 1 Desc','2017-10-10',28,'2017-05-14 11:59:04',1,0.00),(2,'Pack 2','Pack 2 Desc','2017-10-10',45,'2017-05-14 11:59:04',1,0.00),(3,'Trial Package','Trial Package','2017-10-10',30,'2017-05-14 11:33:48',1,0.00);
